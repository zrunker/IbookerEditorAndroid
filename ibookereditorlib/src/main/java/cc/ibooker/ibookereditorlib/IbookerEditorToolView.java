...
public class IbookerEditorToolView extends HorizontalScrollView {
    ...
    private void init(Context context) {
        ...
        setImageBtn(boldIBtn, layoutParams, R.drawable.ibooker_editor_draw_bold, getResources().getString(R.string.bold), IbookerEditorEnum.TOOLVIEW_TAG.IBTN_BOLD);
        toolLayout.addView(boldIBtn);

        // 斜体
        italicIBtn = new ImageButton(context);
        setImageBtn(italicIBtn, layoutParams, R.drawable.ibooker_editor_draw_italic, getResources().getString(R.string.italic), IbookerEditorEnum.TOOLVIEW_TAG.IBTN_ITALIC);
        toolLayout.addView(italicIBtn);

        // 删除线
        strikeoutIBtn = new ImageButton(context);
        setImageBtn(strikeoutIBtn, layoutParams, R.drawable.ibooker_editor_draw_strikeout, getResources().getString(R.string.strikeout), IbookerEditorEnum.TOOLVIEW_TAG.IBTN_STRIKEOUT);
        toolLayout.addView(strikeoutIBtn);

        // 下划线
        underlineIBtn = new ImageButton(context);
        setImageBtn(underlineIBtn, layoutParams, R.drawable.ibooker_editor_draw_underline, getResources().getString(R.string.underline), IbookerEditorEnum.TOOLVIEW_TAG.IBTN_UNDERLINE);
        toolLayout.addView(underlineIBtn);

        // 单词首字母大写
        capitalsIBtn = new ImageButton(context);
        setImageBtn(capitalsIBtn, layoutParams, R.drawable.ibooker_editor_draw_capitals, getResources().getString(R.string.capitals), IbookerEditorEnum.TOOLVIEW_TAG.IBTN_CAPITALS);
        toolLayout.addView(capitalsIBtn);

        // 单词转大写
        uppercaseIBtn = new ImageButton(context);
        setImageBtn(uppercaseIBtn, layoutParams, R.drawable.ibooker_editor_draw_uppercase, getResources().getString(R.string.uppercase), IbookerEditorEnum.TOOLVIEW_TAG.IBTN_UPPERCASE);
        toolLayout.addView(uppercaseIBtn);

        // 单词转小写
        lowercaseIBtn = new ImageButton(context);
        setImageBtn(lowercaseIBtn, layoutParams, R.drawable.ibooker_editor_draw_lowercase, getResources().getString(R.string.lowercase), IbookerEditorEnum.TOOLVIEW_TAG.IBTN_LOWERCASE);
        toolLayout.addView(lowercaseIBtn);

        // 一级标题
        h1IBtn = new ImageButton(context);
        setImageBtn(h1IBtn, layoutParams, R.drawable.ibooker_editor_draw_h1, getResources().getString(R.string.h1), IbookerEditorEnum.TOOLVIEW_TAG.IBTN_H1);
        toolLayout.addView(h1IBtn);

        // 二级标题
        h2IBtn = new ImageButton(context);
        setImageBtn(h2IBtn, layoutParams, R.drawable.ibooker_editor_draw_h2, getResources().getString(R.string.h2), IbookerEditorEnum.TOOLVIEW_TAG.IBTN_H2);
        toolLayout.addView(h2IBtn);

        // 三级标题
        h3IBtn = new ImageButton(context);
        setImageBtn(h3IBtn, layoutParams, R.drawable.ibooker_editor_draw_h3, getResources().getString(R.string.h3), IbookerEditorEnum.TOOLVIEW_TAG.IBTN_H3);
        toolLayout.addView(h3IBtn);

        // 四级标题
        h4IBtn = new ImageButton(context);
        setImageBtn(h4IBtn, layoutParams, R.drawable.ibooker_editor_draw_h4, getResources().getString(R.string.h4), IbookerEditorEnum.TOOLVIEW_TAG.IBTN_H4);
        toolLayout.addView(h4IBtn);

        // 五级标题
        h5IBtn = new ImageButton(context);
        setImageBtn(h5IBtn, layoutParams, R.drawable.ibooker_editor_draw_h5, getResources().getString(R.string.h5), IbookerEditorEnum.TOOLVIEW_TAG.IBTN_H5);
        toolLayout.addView(h5IBtn);

        // 六级标题
        h6IBtn = new ImageButton(context);
        setImageBtn(h6IBtn, layoutParams, R.drawable.ibooker_editor_draw_h6, getResources().getString(R.string.h6), IbookerEditorEnum.TOOLVIEW_TAG.IBTN_H6);
        toolLayout.addView(h6IBtn);

        // 链接
        linkIBtn = new ImageButton(context);
        setImageBtn(linkIBtn, layoutParams, R.drawable.ibooker_editor_draw_link, getResources().getString(R.string.link), IbookerEditorEnum.TOOLVIEW_TAG.IBTN_LINK);
        toolLayout.addView(linkIBtn);

        // 引用
        quoteIBtn = new ImageButton(context);
        setImageBtn(quoteIBtn, layoutParams, R.drawable.ibooker_editor_draw_quote, getResources().getString(R.string.quote), IbookerEditorEnum.TOOLVIEW_TAG.IBTN_QUOTE);
        toolLayout.addView(quoteIBtn);

        // 代码
        codeIBtn = new ImageButton(context);
        setImageBtn(codeIBtn, layoutParams, R.drawable.ibooker_editor_draw_code, getResources().getString(R.string.code), IbookerEditorEnum.TOOLVIEW_TAG.IBTN_CODE);
        toolLayout.addView(codeIBtn);

        // 图片
        imguIBtn = new ImageButton(context);
        setImageBtn(imguIBtn, layoutParams, R.drawable.ibooker_editor_draw_img_u, getResources().getString(R.string.img_u), IbookerEditorEnum.TOOLVIEW_TAG.IBTN_IMG_U);
        toolLayout.addView(imguIBtn);

        // 数字列表
        olIBtn = new ImageButton(context);
        setImageBtn(olIBtn, layoutParams, R.drawable.ibooker_editor_draw_ol, getResources().getString(R.string.ol), IbookerEditorEnum.TOOLVIEW_TAG.IBTN_OL);
        toolLayout.addView(olIBtn);

        // 普通列表
        ulIBtn = new ImageButton(context);
        setImageBtn(ulIBtn, layoutParams, R.drawable.ibooker_editor_draw_ul, getResources().getString(R.string.ul), IbookerEditorEnum.TOOLVIEW_TAG.IBTN_UL);
        toolLayout.addView(ulIBtn);

        // 列表未选中
        unselectedIBtn = new ImageButton(context);
        setImageBtn(unselectedIBtn, layoutParams, R.drawable.ibooker_editor_draw_unselected, getResources().getString(R.string.unselected), IbookerEditorEnum.TOOLVIEW_TAG.IBTN_UNSELECTED);
        toolLayout.addView(unselectedIBtn);

        // 列表选中
        selectedIBtn = new ImageButton(context);
        setImageBtn(selectedIBtn, layoutParams, R.drawable.ibooker_editor_draw_selected, getResources().getString(R.string.selected), IbookerEditorEnum.TOOLVIEW_TAG.IBTN_SELECTED);
        toolLayout.addView(selectedIBtn);

        // 表格
        tableIBtn = new ImageButton(context);
        setImageBtn(tableIBtn, layoutParams, R.drawable.ibooker_editor_draw_table, getResources().getString(R.string.table), IbookerEditorEnum.TOOLVIEW_TAG.IBTN_TABLE);
        toolLayout.addView(tableIBtn);

        // HTML
        htmlIBtn = new ImageButton(context);
        setImageBtn(htmlIBtn, layoutParams, R.drawable.ibooker_editor_draw_html, getResources().getString(R.string.html), IbookerEditorEnum.TOOLVIEW_TAG.IBTN_HTML);
        toolLayout.addView(htmlIBtn);

        // 分割线
        hrIBtn = new ImageButton(context);
        setImageBtn(hrIBtn, layoutParams, R.drawable.ibooker_editor_draw_hr, getResources().getString(R.string.hr), IbookerEditorEnum.TOOLVIEW_TAG.IBTN_HR);
        toolLayout.addView(hrIBtn);

        // 表情
        emojiIBtn = new ImageButton(context);
        setImageBtn(emojiIBtn, layoutParams, R.drawable.ibooker_editor_draw_emoji, getResources().getString(R.string.emoji), IbookerEditorEnum.TOOLVIEW_TAG.IBTN_EMOJI);
